...
@section('content')
 ...
 @push('js')
 <script type="text/javascript" src='https://maps.google.com/maps/api/js?sensor=false&libraries=places&key=AIzaSyDyWlSVodW3xqkoCqnrbrwH3HSKy34josM'></script>
 <script type="text/javascript" src='{{ asset('Design/admin/dist/js/locationpicker.jquery.js') }}'></script>
<?php
...
?>
 <script>
  $('#us1').locationpicker({
      ...
      radius: 300,
      markerIcon: '{{ asset('Design/admin/dist/img/map-marker-2-xl.png') }}',
      inputBinding: {
        latitudeInput: $('#lat'),
        longitudeInput: $('#lng'),
