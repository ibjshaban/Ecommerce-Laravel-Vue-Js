...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin'], function () {
    ...
    Config::set('auth.defines', 'user');
    Route::get('login-users', 'UserAuthController@login');
    Route::post('login-users', 'UserAuthController@doLogin');
    ...
    Route::post('reset/password/{token}', 'AdminAuthController@reset_password_final');
        ...
        Route::group(['middleware' => 'AdminOrSeller'], function () {
        //Route::group(['middleware' => 'admin:admin'], function () {
            ...
            Route::any('logout/users', 'UserAuthController@logout')->name('logout.user');
